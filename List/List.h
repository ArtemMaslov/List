...
struct List
{
    listType* data;  /// Массив данных

    size_t* next;    /// Массив, хранящий индексы следующего элемента списка
    size_t* prev;    /// Массив,  хранящий индексы предудыщего элемента списка

    size_t capacity; /// Вместимость списка. Максимальное допустимое число хранимых элементов
    size_t head;     /// Индекс начальнлого элемента списка
    size_t tail;     /// Индекс конечного элемента списка
};
