...
1. Скачать репозиторий библиотеки:
```
git clone https://github.com/ArtemMaslov/List
```
2. Добавить в проект файлы `List.cpp` и `List.h`.
3. В заголовочном файле `List.h` содержатся функции для работы со списком.
